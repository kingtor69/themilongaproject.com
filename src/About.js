    ...
    return (
        <div className="About">
            ...
            <div className="About-p">
                ...
                <p>Something initially simple became very complicated — thousands of photographs to produce the 450 images used in the final project.  Many actors, both for the visuals and the soundtrack.  Heroic recording and mixing by Tor, Spectacular Foley and sound design by Kat.  Generous musical contributions by Q-Tango, and a score by CK Barlow.  Visual editing by Brad Stoddard. </p>
